...
class submap
{
    public:
        ...
        bool has_tcolor( const point &p ) const;
        const std::string &get_tcolor( const point &p ) const;
        void set_tcolor( const point &p, const std::string &color );
        void delete_tcolor( const point &p );
