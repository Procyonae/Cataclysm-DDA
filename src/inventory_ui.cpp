...
void uistatedata::serialize( JsonOut &json ) const
{
    ...
    json.member( "overmap_show_most_recently_revealed_map", overmap_show_most_recently_revealed_map );
...
void uistatedata::deserialize( const JsonObject &jo )
{
    ...
    jo.read( "overmap_show_most_recently_revealed_map", overmap_show_most_recently_revealed_map );
